...
const Cart = () => {
  ...
  const generateAvailableTimeSlots = (selectedDate) => {
    ...
    // If today, ensure minimum 30 minutes preparation time
    if (isToday) {
      const minTime = new Date(now.getTime() + 30 * 60000); // Add 30 minutes
      if (
        minTime.getHours() >= storeOpenHour &&
        minTime.getHours() < storeCloseHour
      ) {
        startHour = minTime.getHours();
        startMinute = Math.ceil(minTime.getMinutes() / 15) * 15; // Round up to next 15-minute interval
        if (startMinute >= 60) {
          startHour += 1;
          startMinute = 0;
        }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-3xl shadow-lg p-6 border border-gray-100">
              ...
              {/* Date Selection */}
              <div className="mb-6">
                <h4 className="font-semibold text-gray-800 mb-3">Chọn Ngày</h4>
                ...
                <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-2xl border border-blue-100 mb-6">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-blue-700">
                      {
                        pickupDates.find((d) => d.value === selectedPickupDate)
                          ?.label
                      }{" "}
                      - {selectedPickupTime}
                    </div>
